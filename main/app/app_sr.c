...
static const sr_cmd_t g_default_cmd_info[] = {
    ...
    {SR_CMD_AC_ON, SR_LANG_EN, 0, "Set the temperature to seventy", "SfT jc TfMPRcpk To SfVcNTm", {NULL}},
    {SR_CMD_AC_OFF, SR_LANG_EN, 0, "Set the temperature to sixty five", "SfT jc TfMPRcpk To SgKSTm FiV", {NULL}},
    {SR_CMD_MAX, SR_LANG_EN, 0, "Call the Nurse", "KeL jc NkS", {NULL}},
